...
export function AppContent({
    ...
    return (
        <main className="flex flex-1 flex-col px-0 py-px sm:px-2" {...props}>
            <div id="main-content-wrapper bg-weaker ring-weaker relative mx-auto flex w-full grow flex-col items-stretch rounded-none shadow-xs ring-0 sm:rounded-lg sm:ring-1">
                <div
