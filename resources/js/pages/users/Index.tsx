            ...
            <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <form id="invite-form" onSubmit={submitInvitation}>
                    <Card className="mb-4">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Add new members to your organization by sending
                ...
                <Card className="mb-4">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Invitations that have been sent but not yet
                            accepted.
                        </CardDescription>
                    </CardHeader>
                </Card>
                    ...
                    <Card className="mb-8">
                        <CardContent className="pt-6">
                            <div className="text-center text-gray-500">
                                ...
                                <p className="text-sm">
                                    There are no pending invitations at the
                                    moment.
                                </p>
                            </div>
                        </CardContent>
                ...
                <Card className="mb-4">
                    <CardHeader>
                        ...
                        <CardDescription>
                            People who are currently members of your
                            organization.
                        </CardDescription>
                    </CardHeader>
                </Card>
