            ...
            <div className="relative min-h-screen overflow-hidden bg-[#fdf9f4] text-[#1c1c1a] dark:bg-[#030202] dark:text-[#ededec]">
                ...
                <div className="relative z-10 flex min-h-screen flex-col">
                    ...
                    <main className="flex flex-1 flex-col justify-center px-6 pt-6 pb-16 lg:px-12 lg:pb-24">
                        <div className="mx-auto grid w-full max-w-[1180px] items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,0.85fr)]">
                            ...
                            <div className="relative mt-2 overflow-hidden rounded-[28px] border border-white/60 bg-gradient-to-br from-[#fff7ef] via-[#ffe6d8] to-[#ffe8fb] p-8 shadow-[0px_30px_80px_rgba(255,126,63,0.25)] dark:border-[#2d140c] dark:from-[#1b0c05] dark:via-[#150608] dark:to-[#210b16] dark:shadow-[0px_25px_70px_rgba(255,108,64,0.2)]">
