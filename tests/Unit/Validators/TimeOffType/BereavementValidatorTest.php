...
covers(BereavementValidator::class);
...
beforeEach(function (): void {
    ...
    /** @var BereavementValidator $validator */
    $validator = app(BereavementValidator::class);
...
test('validates successfully for future date', function (): void {
    $data = [
        ...
        'type' => TimeOffType::Bereavement->value,
...
test('does not check balance for bereavement', function (): void {
    $data = [
        'organization_id' => $this->organization->id,
        'employee_id' => $this->employee->id,
        'type' => TimeOffType::Bereavement->value,
